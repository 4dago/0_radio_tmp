    ...
    const  uint8_t  font2[] PROGMEM = {
        ...
        0x00, 0x00, 0x00, 0x00, 0x00,       //00
            ...
            0x4C, 0x92, 0x96, 0x93, 0x64,   //140   // Ś
            0x00, 0x01, 0x45, 0x7C, 0x40,
            0xF0, 0x29, 0x24, 0x29, 0xF0,
            0xC2, 0xA6, 0x93, 0x8A, 0x86,   //143   // Ź
            ...
            0x48, 0x54, 0x56, 0x55, 0x24,   //156   // ś
            0x2B, 0x2F, 0xFC, 0x2F, 0x2B,
            0xFF, 0x09, 0x29, 0xF6, 0x20,
            0x44, 0x64, 0x56, 0x4D, 0x44,   //159   // ź

            0x20, 0x54, 0x54, 0x79, 0x41,   //160
            0x00, 0x00, 0x44, 0x7D, 0x41,
            0x30, 0x48, 0x48, 0x4A, 0x32,
            0x7F, 0x50, 0x48, 0x44, 0x40,   //163   // Ł
            0x00, 0x7A, 0x0A, 0x0A, 0x72,
            0x7C, 0x12, 0x11, 0xD2, 0x7C,   //165   // Ą
            ...
            0x69, 0x59, 0x49, 0x4D, 0x4B,   //175   // Ż
            0xAA, 0x00, 0x55, 0x00, 0xAA,
            0xAA, 0x55, 0xAA, 0x55, 0xAA,
            0x00, 0x00, 0x00, 0xFF, 0x00,
            0x00, 0x49, 0x7F, 0x44, 0x00,   //179   // ł
            ...
            0x20, 0x54, 0x54, 0xF8, 0x40,   //185   // ą
            ...
            0x44, 0x64, 0x55, 0x4C, 0x44,   //192   // ż
            ...
            0x7C, 0x82, 0x86, 0x83, 0x44,   //199   // ć

            0x00, 0x00, 0x1F, 0x10, 0x17,   //200
            0x00, 0x00, 0xFC, 0x04, 0xF4,
            0x14, 0x14, 0x17, 0x10, 0x17,
            0x7F, 0x49, 0xC9, 0xC9, 0x41,   //203   //Ę
            ...
            0xFE, 0x08, 0x12, 0x21, 0xFE,   //210   // Ń
            0x00, 0x00, 0x1F, 0x10, 0x1F,
            0x7C, 0x82, 0x86, 0x83, 0x7C,   ///212  // Ó TO PEWNIE NIEPOTRZEBNE ALE...
            ...
            0x38, 0x44, 0x46, 0x45, 0x28,   //231   // ć
            0x99, 0xA5, 0xE7, 0xA5, 0x99,
            0x1C, 0x2A, 0x49, 0x2A, 0x1C,
            0x4C, 0x72, 0x01, 0x72, 0x4C,
            0x38, 0x54, 0xD4, 0xD4, 0x18,   //235   // ę
            ...
            0x7C, 0x08, 0x06, 0x05, 0x78,   //242   // ń
            0x40, 0x44, 0x4A, 0x51, 0x40,
            0x38, 0x44, 0x46, 0x45, 0x38,   //244   // ó
